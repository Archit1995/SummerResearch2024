...
MRFI_Vector:=proc(B, num_vars::integer, num_eqn::integer, vars::list, p::integer)
    ...
    for k from 1 to num_eqn do
        ...
        print("MRFI lambda_num_eval[",k,"]:", lambda_num_eval[k]):
    ...
    print("coeff_num_eval: ",coeff_num_eval):
    print("final_num_eval: ",final_num_eval):
    ...
    print("coeff_den_eval: ",coeff_den_eval):
    print("final_den_eval: ",final_den_eval):
