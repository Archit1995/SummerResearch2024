...
%
% \usepackage{subfiles}% used to decompose a large latex document into multiple 
...
\mainmatter%
\include{1_chapter1/chapter1}
\include{2_MQRFR/mqrfr}
\include{3_BenOr_Tiwari/benOr_tiwari}

\include{4_Rational_function_reconstruction/4_rational_function_reconstruction}
%   BACK MATTER  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
